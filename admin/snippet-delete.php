...
if($snippetCount==0){
	...
	$wpdb->query( 'DELETE FROM  '.$wpdb->prefix.'cc_ihs_short_code  WHERE id="'.$cc_ihs_snippetId.'" ' ) ;
	
	header("Location:".admin_url('admin.php?page=insert-html-snippet-manage&cc_ihs_msg=3&pagenum='.$cc_ihs_pageno));
	exit();
